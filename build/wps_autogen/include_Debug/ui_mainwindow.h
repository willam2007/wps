...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy1.setHeightForWidth(choose_project_frame->sizePolicy().hasHeightForWidth());
        choose_project_frame->setSizePolicy(sizePolicy1);
        ...
        sizePolicy2.setHeightForWidth(choose_project_frame1->sizePolicy().hasHeightForWidth());
        choose_project_frame1->setSizePolicy(sizePolicy2);
        ...
        sizePolicy.setHeightForWidth(create_button_project->sizePolicy().hasHeightForWidth());
        create_button_project->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(choose_button_project->sizePolicy().hasHeightForWidth());
        choose_button_project->setSizePolicy(sizePolicy);
